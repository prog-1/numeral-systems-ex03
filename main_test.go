...
func TestLongAdd(t *testing.T) {
	for _, tc := range []struct {
		...
		{"Nines", "999999999999999999999999999999999", "1", "1" + addZeros("", 33)},
...
func TestLongAddWithBase(t *testing.T) {
	for _, tc := range []struct {
		...
		{"base 2 sum", "1", "1", 2, "10"},
		{"base 7 sum", "666666666666666666666666666666666666666666666666666666666666666666666666666666666666666", "1", 7, "1" + addZeros("", 87)},
	} {
		t.Run(tc.name, func(t *testing.T) {
